            ...
            Column {
                ...
                OutlinedTextField(
                    ...
                    trailingIcon = {
                        IconButton(
                            onClick = {
                                viewModel.visualPassword = viewModel.changePasswordVisual(viewModel.visualPassword)
                            }
                        ) {
            ...
            Column {
                ...
                OutlinedTextField(
                    ...
                    trailingIcon = {
                        IconButton(
                            onClick = {
                                viewModel.visualReEnterPassword = viewModel.changePasswordVisual(viewModel.visualReEnterPassword)
                            }
                        ) {
